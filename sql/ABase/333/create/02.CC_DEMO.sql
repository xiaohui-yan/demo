...
comment on column T_Student.C_ID                             is 'uuid';
comment on column T_Student.C_NAME                             is '学生姓名';
comment on column T_Student.N_AGE                             is '学生年龄';
comment on column T_Student.D_BIRTHDAY                             is '学生生日';
comment on column T_Student.C_DESC                             is '学生名次';
